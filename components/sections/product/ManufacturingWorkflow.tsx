              ...
              return (
                ...
                >
                  <div className="flex items-center gap-24">
                    <span className="w-56 shrink-0 text-p3 text-neutral-3">{step.label}</span>
                    ...
                    <PanelsTopLeft size={40} className="shrink-0 text-secondary" aria-hidden="true" />
                  </div>
                  <div className="flex flex-col gap-12 pr-0 md:pr-48">
                    <Heading level={3} size="h5" className="text-neutral-3">
                      {step.title}
                    </Heading>
                    <Text size="p1" className="text-neutral-3">
                      {step.body}
