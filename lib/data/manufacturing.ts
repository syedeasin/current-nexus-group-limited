...
export const productCategories: Record<string, ProductCategory> = {
  "solar-panels": {
    ...
    bannerImage: "/images/manufacturing/banner-solar-panels.jpg",
    whyChooseImage: "/images/manufacturing/why-choose-manufacturing.jpg",
    ctaImage: "/images/manufacturing/cta-factory.jpg",
    products: [
      {
        slug: "bc",
      ...
      },
      {
        ...
        image: "/images/manufacturing/product-hjt.jpg",
      },
      {
        slug: "topcon",
  ...
  bess: {
    ...
    bannerImage: "/images/manufacturing/banner-bess.jpg",
    whyChooseImage: "/images/manufacturing/why-choose-manufacturing.jpg",
    ctaImage: "/images/manufacturing/cta-factory.jpg",
    products: [
      {
        ...
        image: "/images/manufacturing/product-residential-bess.jpg",
        featured: true,
      },
      {
        slug: "112kwh",
        ...
        image: "/images/manufacturing/product-112kwh-bess.jpg",
      },
      {
        slug: "261kwh",
        titleKey: "products.kwh261.title",
        descriptionKey: "products.kwh261.description",
        image: "/images/manufacturing/product-261kwh-bess.jpg",
      },
      {
        slug: "488kwh",
